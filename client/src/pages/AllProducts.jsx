    ...
    if (selectedCategories.length > 0) {
      ...
      data = data.filter((product) => {
        ...
        return productCats.some((cat) => {
          ...
          return (
            selectedCategories.includes(pId) ||
            (typeof pName === "string" &&
              selectedCategoryNames.includes(pName.toLowerCase()))
          );
        });
      });
    }
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        >
          ...
          <div className="border-b border-gray-100 pb-8 mb-8">
            <h3 className="text-md font-bold text-[#1E2A5E] mb-5 uppercase tracking-wide">
              Category
            </h3>
        ...
        <div className="flex-1">
          {/* Toolbar: */}
          <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-100 gap-2">
            {/* Filter Button */}
            <button
              onClick={() => setShowFilter(true)}
              className="lg:hidden flex items-center gap-1.5 px-3 py-1.5 border border-slate-200 rounded-md text-[11px] font-black text-slate-900 shrink-0"
            >
              <SlidersHorizontal size={14} /> FILTER
            </button>

            {/* Sort Section - Prevent Wrap */}
            <div className="flex items-center gap-1.5 ml-auto">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-slate-100 border-none pl-2 pr-7 py-1.5 rounded-md text-[11px] font-bold text-slate-900 cursor-pointer outline-none active:ring-1 active:ring-indigo-500"
                >
